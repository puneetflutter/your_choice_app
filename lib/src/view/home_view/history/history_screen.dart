...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  var modelsheetController = Get.find<AuthController>();
  @override
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                'Total Payment Transaction History"s',
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: TextField(
                                                          ...
                                                          decoration: InputDecoration(
                                                              prefixIcon:
                                                                  Image.asset(
                                                                      'assets/icons/dateimage.png'),
                                                              suffixIcon:
                                                                  Image.asset(
                                                                      'assets/icons/dropdwonicon.png'),
                                                              border:
                                                                  OutlineInputBorder()),
                                                        ),
                                                      ),
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  'All Transactions',
                                                                  style: TextStyle(
                                                                      color: modelsheetController.dropdrownindex.value ==
                                                                              0
                                                                          ? ywhite
                                                                          : yblue),
                                                                ),
                                                        ...
                                                        children: [
                                                          Checkbox(
                                                              ...
                                                              onChanged: (bool?
                                                                  value) {
                                                                setState(() {
                                                                  modelsheetController.transaction(
                                                                      !modelsheetController
                                                                          .transaction
                                                                          .value);
                                                                });
                                                        ...
                                                        children: [
                                                          Checkbox(
                                                              ...
                                                              onChanged: (bool?
                                                                  value) {
                                                                setState(() {
                                                                  modelsheetController.moneypaid(
                                                                      !modelsheetController
                                                                          .moneypaid
                                                                          .value);
                                                                });
                                                        ...
                                                        children: [
                                                          Checkbox(
                                                              ...
                                                              onChanged: (bool?
                                                                  value) {
                                                                setState(() {
                                                                  modelsheetController.allcategory(
                                                                      !modelsheetController
                                                                          .allcategory
                                                                          .value);
                                                                });
                                                        ...
                                                        children: [
                                                          Checkbox(
                                                              ...
                                                              onChanged: (bool?
                                                                  value) {
                                                                setState(() {
                                                                  modelsheetController.businesspay(
                                                                      !modelsheetController
                                                                          .businesspay
                                                                          .value);
                                                                });
                                                        ...
                                                        children: [
                                                          Checkbox(
                                                              ...
                                                              onChanged: (bool?
                                                                  value) {
                                                                setState(() {
                                                                  modelsheetController.paymentlink(
                                                                      !modelsheetController
                                                                          .paymentlink
                                                                          .value);
                                                                });
