  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'New Payee Add',
          style: primaryFontsemiBold.copyWith(color: yblue, fontSize: 20),
        ),
        centerTitle: true,
      ),
      body: SafeArea(
          ...
          Form(
            ...
            child: Column(
              children: [
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        labelStyle: TextStyle(color: yblue),
                ...
                //     child: Text(
                //       'GET PAYEE NAME',
                //       style: TextStyle(color: ywhite, fontSize: 18),
                //     ),
                //   ),
                // ),
                ysizedbox40,
               Obx(()=> addnewpayController.isLoading.isTrue ? Container(
                          height: 58,
                          width: 310,
                          decoration: BoxDecoration(
                              color: yindigo,
